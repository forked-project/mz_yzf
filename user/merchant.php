...
<div class="bg-light lter b-b wrapper-md hidden-print">
  <h1 class="m-n font-thin h3">修改商户资料</h1>
</div>
		...
		<div class="panel-body">
			<form class="form-horizontal devform">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="url" value="<?php echo $merchant['url']?>" disabled>
                    </div>
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select class="form-control" name="stype" default="<?php echo $merchant['settle_id']?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" type="text" name="account" value="<?php echo $merchant['account']?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">真实姓名</label>
					<div class="col-sm-9">
						<input class="form-control" type="text" name="username" value="<?php echo $merchant['username']?>">
					</div>
				</div>
